...
protected:
  ...
  // pubs
  rclcpp::Publisher<decomp_ros_msgs::msg::PolyhedronStamped>::SharedPtr pub_polygon_;
  rclcpp::Publisher<geometry_msgs::msg::PolygonStamped>::SharedPtr pub_polygon_viz_;
