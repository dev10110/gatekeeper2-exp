...
SeedDecomp::SeedDecomp(const rclcpp::NodeOptions &options)
  ...
  pub_polygon_ = this->create_publisher<decomp_ros_msgs::msg::PolyhedronStamped>(
      "sfc", 10);
...
void SeedDecomp::publish_polyhedron(const std_msgs::msg::Header header, Polyhedron3D poly) const 
{
...
void SeedDecomp::publish_polygon_stamped(const std_msgs::msg::Header header, Polyhedron3D poly ) const
{
